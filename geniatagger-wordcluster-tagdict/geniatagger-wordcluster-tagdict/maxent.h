...
public:
  ME_Sample() : label("") {
    //pwordclusterpath = new wordClusterPath();
  };
  /*
  ~ME_Sample(){
    if(pwordclusterpath != NULL){
        delete pwordclusterpath;
        pwordclusterpath = NULL;
    }
  }
  */
...
public:
  //wordClusterPath * pwordclusterpath;
  //wordListFeatures * pwordlistfeature;
  std::string label;
